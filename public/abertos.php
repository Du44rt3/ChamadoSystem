...
<head>
    ...
    <title>Chamados Abertos - ELUS Facilities</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="search-bar">
            <div class="row">
                <div class="col-md-10">
                    <form method="GET" action="abertos.php" class="d-flex">
                        <div class="input-group">
                            ...
                            <?php if(isset($_GET['pesquisa']) && !empty($_GET['pesquisa'])): ?>
                                <a href="abertos.php" class="btn btn-secondary">
        ...
        if(isset($_GET['pesquisa']) && !empty($_GET['pesquisa'])){
            $stmt = $chamado->searchByStatus($_GET['pesquisa'], 'aberto');
            ...
            $stmt = $chamado->readByStatus('aberto');
        }
        ...
        if($num > 0){
            ...
            echo "<h5 class='mb-0'><i class='fas fa-exclamation-circle me-2 text-info'></i>Chamados Abertos <span class='badge bg-info ms-2'>{$num}</span></h5>";
            ...
            foreach($rows as $row){
                ...
                // Definir cor do card baseado na gravidade
                $card_border = '';
                switch($gravidade) {
                    case 'alta':
                ...
                // Header do Card com status aberto
            ...
            foreach($rows as $row){
                ...
                echo "</td>";
                echo "<td class='text-center'><span class='status-badge status-aberto'><i class='fas fa-circle me-1'></i>Aberto</span></td>";
                echo "<td class='text-center'>";
                echo "<div class='btn-group btn-group-sm' role='group'>";
            ...
            echo "<div class='d-flex justify-content-center align-items-center mt-4 p-3 bg-info bg-opacity-10 border border-info rounded'>";
            echo "<small class='text-info'><i class='fas fa-info-circle me-2'></i>Total de <strong>{$num}</strong> chamado(s) aguardando atendimento</small>";
            echo "</div>";
            ...
            if(isset($_GET['pesquisa']) && !empty($_GET['pesquisa'])){
                ...
                echo "<div>";
                echo "<strong>Nenhum chamado aberto encontrado</strong><br>";
                echo "<small>Tente ajustar os termos da pesquisa ou <a href='abertos.php' class='alert-link'>ver todos os chamados abertos</a></small>";
                echo "</div>";
                echo "</div>";
            } else {
                echo "<div class='alert alert-success d-flex align-items-center'>";
                echo "<i class='fas fa-check-circle me-3'></i>";
                echo "<div>";
                echo "<strong>Todos os chamados foram atendidos!</strong><br>";
                echo "<small>Não há chamados pendentes no momento. <a href='add.php' class='alert-link'>Criar novo chamado</a></small>";
                echo "</div>";
                echo "</div>";
            }
        }
